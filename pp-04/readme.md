...
Copy and paste the URL for your personal fork of the repository here: https://github.com/Knoll0/project-2
...
Write or copy & paste the output of `git remote -v` from your copy of the forked repository here:
  ...
  origin	git@github.com:Knoll0/project-2.git (fetch)
  origin	git@github.com:Knoll0/project-2.git (push)
  upstream	https://github.com/webdevmaestros/project-2.git (fetch)
  upstream	https://github.com/webdevmaestros/project-2.git (push)
...
Copy and paste the URL of your pull request here: https://github.com/webdevmaestros/project-2/pull/4
